...
class apb_driver_cfg extends uvm_object;
  ...
  //pre_randomize.Handle random data information before randomize
  extern function void pre_randomize();

  //post_randomize.Handle random data information after randomize
  extern function void post_randomize();

  //Define the function/task base on project requirement
  //-------------------------------Coding begin-------------------------------//
  //%%%%%%%%%%%%%%%
  //-------------------------------Coding end-------------------------------//
...
endclass:apb_driver_cfg
  ...
  //Define constraints of the variables base on project requirement
  //-------------------------------Coding begin-------------------------------//
  //%%%%%%%%%%%%%%%
  //-------------------------------Coding end-------------------------------//
...
function apb_driver_cfg::new(string name = "apb_driver_cfg");
   super.new(name);
   //Add the initial of variables base on project requirement
   //-------------------------------Coding begin-------------------------------//
   //%%%%%%%%%%%%%%%
   //-------------------------------Coding end-------------------------------//
endfunction: new
...
function void apb_driver_cfg::pre_randomize;
  super.pre_randomize();
   //Extend pre_randomize() base on project requirement
   //-------------------------------Coding begin-------------------------------//
   //%%%%%%%%%%%%%%%
   //-------------------------------Coding end-------------------------------//
...
function void apb_driver_cfg::post_randomize;
  super.post_randomize();
   //Extend post_randomize() base on project requirement
   //-------------------------------Coding begin-------------------------------//
   //%%%%%%%%%%%%%%%
   //-------------------------------Coding end-------------------------------//
